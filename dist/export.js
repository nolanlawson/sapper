...
function _export(_a) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        function handle(url$$1) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var pathname, timeout_deferred, the_timeout, r, type, body, range, urls, cleaned, base_match, base_href, base, match, pattern, attrs, href, url_1, location;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!(type === 'text/html' && pathname !== '/service-worker-index.html')) return [3 /*break*/, 4];
                            urls = [];
                            ...
                            return [4 /*yield*/, Promise.all(urls.map(handle))];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4:
        ...
        var port, protocol, host, origin, root, proc, seen, saved;

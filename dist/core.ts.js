...
function create_main_manifests(_a) {
    ...
    var path_to_routes = path.relative(__chunk2_js.locations.app() + "/manifest", __chunk2_js.locations.routes());
    ...
    write_if_changed(__chunk2_js.locations.app() + "/manifest/client.js", client_manifest);
    write_if_changed(__chunk2_js.locations.app() + "/manifest/server.js", server_manifest);
}
function create_serviceworker_manifest(_a) {
    ...
    write_if_changed(__chunk2_js.locations.app() + "/manifest/service-worker.js", code);
}
function generate_client(routes, path_to_routes, dev_port) {
    var code = ("\n\t\t// This file is generated by Sapper \u2014 do not edit it!\n\t\texport const routes = [\n\t\t\t" + routes
        ...
        var file = posixify(path_to_routes + "/" + route.file);
...
function create_routes(_a) {
    var files = (_a === void 0 ? { files: glob__default.sync('**/*.*', { cwd: __chunk2_js.locations.routes(), nodir: true }) } : _a).files;
    var routes = files
        .map(function (file) {
        if (/(^|\/|\\)_/.test(file))
            return;
